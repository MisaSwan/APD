        ...
        <div data-role="page" data-theme="b">
            ...
            <div class="ui-body ui-body-b ui-corner-all">
                <div class="ui-field-contain ui-filterable">                    
                    <input type="search" name="search" id="filterBasic-input" value="" data-type="search" placeholder="Buscar Produtos">
                </div>
                <ul data-role="listview" data-split-icon="custom" data-theme="a"  data-split-theme="b" data-inset="true" data-filter="true" data-input="#filterBasic-input">
                    <li><a href="#">                            
